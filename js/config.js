...
export const UNIT_TYPES = {
    ...
    assault_infantry: {
        ...
        cost: 1, hp: 100, attack: 15, defense: 5, range: 4 * TILE_SIZE, speed: 1.5 * TILE_SIZE, attackSpeed: 1.2, visionRange: range * 1.5,
    ...
    sniper: {
        ...
        cost: 3, hp: 70, attack: 50, defense: 0, range: 9 * TILE_SIZE, speed: 1.2 * TILE_SIZE, attackSpeed: 4.0, visionRange: range * 1.5,
    ...
    anti_tank_trooper: {
        ...
        cost: 2, hp: 90, attack: 25, defense: 5, range: 5 * TILE_SIZE, speed: 1.3 * TILE_SIZE, attackSpeed: 2.5, visionRange: range * 1.5,
    ...
    main_battle_tank: {
        ...
        cost: 5, hp: 400, attack: 50, defense: 35, range: 6 * TILE_SIZE, speed: 1.1 * TILE_SIZE, attackSpeed: 2.2, visionRange: range * 1.5,
    ...
    light_tank: {
        ...
        cost: 3, hp: 250, attack: 30, defense: 20, range: 5 * TILE_SIZE, speed: 1.8 * TILE_SIZE, attackSpeed: 1.8, visionRange: range * 1.5,
    ...
    amphibious_tank: {
        ...
        cost: 4, hp: 300, attack: 35, defense: 25, range: 5 * TILE_SIZE, speed: 1.2 * TILE_SIZE, attackSpeed: 2.0, visionRange: range * 1.5,
    ...
    fighter_jet: {
        ...
        cost: 6, hp: 200, attack: 60, defense: 10, range: 8 * TILE_SIZE, speed: 5.0 * TILE_SIZE, attackSpeed: 2.0, visionRange: range * 1.5,
    ...
    attack_helicopter: {
        ...
        cost: 5, hp: 250, attack: 40, defense: 15, range: 7 * TILE_SIZE, speed: 3.0 * TILE_SIZE, attackSpeed: 1.8, visionRange: range * 1.5,
    ...
    recon_drone: {
        ...
        cost: 2, hp: 50, attack: 0, defense: 0, range: 0, speed: 4.0 * TILE_SIZE, attackSpeed: 99, visionRange: range * 1.5,
    ...
    howitzer: {
        ...
        cost: 6, hp: 120, attack: 100, defense: 5, range: 12 * TILE_SIZE, speed: 0.8 * TILE_SIZE, attackSpeed: 5.0, visionRange: range * 1.5,
    ...
    sam_launcher: {
        ...
        cost: 5, hp: 150, attack: 80, defense: 10, range: 10 * TILE_SIZE, speed: 1.0 * TILE_SIZE, attackSpeed: 0.4, visionRange: range * 1.5,
    ...
    destroyer: {
        ...
        cost: 8, hp: 600, attack: 70, defense: 30, range: 9 * TILE_SIZE, speed: 1.5 * TILE_SIZE, attackSpeed: 2.8, visionRange: range * 1.5,
    ...
    submarine: {
        ...
        cost: 7, hp: 400, attack: 90, defense: 15, range: 8 * TILE_SIZE, speed: 1.8 * TILE_SIZE, attackSpeed: 3.5, visionRange: range * 1.5,

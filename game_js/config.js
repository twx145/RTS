...
const UNIT_TYPES = {
    ...
    anti_tank_trooper: {
        ...
        ammoType: 'shell', ammoSpeed: 12 * TILE_SIZE * AMMOSPEED, ammoSplashRadius: 0.5 * TILE_SIZE, counters: { armor: 1.8 },
    ...
    main_battle_tank: {
        ...
        moveType: 'ground', unitType: 'armor', canTarget: ['ground','amphibious','sea'], imageSrc: '../assets/pics/main_battle_tank.png', drawScale: 3 * DRAW_SCALE_FACTOR,
    ...
    light_tank: {
        ...
        moveType: 'ground', unitType: 'armor', canTarget: ['ground','amphibious','sea'], imageSrc: '../assets/pics/light_tank.png', drawScale: 3 * DRAW_SCALE_FACTOR,
    ...
    amphibious_tank: {
        ...
        moveType: 'amphibious', unitType: 'armor', canTarget: ['ground', 'sea','amphibious','sea'], imageSrc: '../assets/pics/amphibious_tank.png', drawScale: 3 * DRAW_SCALE_FACTOR,
        ammoType: 'missile', ammoSpeed: 15 * TILE_SIZE * AMMOSPEED, ammoSplashRadius: 0,
    ...
    attack_helicopter: {
        ...
        moveType: 'air', unitType: 'air', canTarget: ['ground', 'sea','amphibious'], imageSrc: '../assets/pics/attack_helicopter.jpg', drawScale: 3 * DRAW_SCALE_FACTOR,
        ammoType: 'missile', ammoSpeed: 15 * TILE_SIZE * AMMOSPEED, ammoSplashRadius: 0, counters: { armor: 1.4 },
    ...
    recon_drone: {
        ...
        moveType: 'air', unitType: 'air', canTarget: [], imageSrc: '../assets/pics/recon_drone.png', drawScale: 1.5 * DRAW_SCALE_FACTOR,

class Game {
    ...
    init(settings) {
        ...
        // --- 核心新增: 初始化 Matter.js 引擎 ---
        this.engine = Matter.Engine.create();
        this.engine.world.gravity.y = 0; // 顶视角游戏，禁用重力
    ...
    update(deltaTime) {
        ...
        // --- 核心修改: 更新 Matter.js 引擎 ---
        // Matter.js 期望以毫秒为单位的 delta
